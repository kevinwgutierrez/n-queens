 ...
 */
    ...
    hasAnyRowConflicts: function() {
      // check if row index has any queens
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      for (
        ;
        colIndex < boardSize && rowIndex < boardSize;
        rowIndex++, colIndex++
      ) {
        if (colIndex >= 0) {
          var row = this.get(rowIndex);
    ...
    hasAnyMajorDiagonalConflicts: function() {
      var boardSize = this.get("n");
      var startColIndex = 1 - boardSize;
      for (; startColIndex < boardSize; startColIndex++) {
        if (this.hasMajorDiagonalConflictAt(startColIndex)) {
          return true;
        }
      }
      return false;
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      for (; colIndex >= 0 && rowIndex < boardSize; rowIndex++, colIndex--) {
    ...
    hasAnyMinorDiagonalConflicts: function() {
      var boardSize = this.get("n");
      var startColIndex = boardSize * 2 - 1;
      for (; startColIndex >= 0; startColIndex--) {
        if (this.hasMinorDiagonalConflictAt(startColIndex)) {
          return true;
        }
      }
      return false;
